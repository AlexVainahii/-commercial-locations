...
export const getcentrMap = (originRoute, destinationRoute) => {
  const centerLat = (originRoute.lat + destinationRoute.lat) / 2;
  const centerLng = (originRoute.lng + destinationRoute.lng) / 2;
